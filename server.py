...
# Wait for user input
while True:
    input_str = input("Server is ready. You can type intergers and then click [ENTER].  Clients will show the mean, median, and mode of the input values.")
...
# Send to Client 1
response_msg = socket_agent.request_msg()
# Send to Client 2
